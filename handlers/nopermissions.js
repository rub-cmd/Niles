...
let allCommands = ["help", "clean", "purge", "init", "update", "sync", "display", "create", "scrim", "delete", "stats", "info", "id", "tz", "invite", "prefix", "admin", "setup", "count", "ping", "displayoptions", "timers", "cold", "apples", "vision", "pyro", "saar", "rub", "optimus"];
